...
class App(tk.Tk):
    ...
    def _build_ui(self):
        ...
        tk.Button(bar, text="Ctrl+V beillesztés (Input)", command=self.paste_to_input).pack(side=tk.LEFT, padx=4)
    ...
    def paste_to_input(self):
        try:
            ...
            messagebox.showinfo(APP_TITLE, "A vágólap üres.")
            return
        self.in_text.insert(tk.INSERT, clip)

    def copy_output(self):
        out = self.out_text.get("1.0", tk.END).rstrip("\n")
        self.clipboard_clear()
        self.clipboard_append(out)
        self.set_status("Output a vágólapra másolva")

    def clear_all(self):
        self.in_text.delete("1.0", tk.END)
        self.out_text.delete("1.0", tk.END)
        self._current_path = None
        self.set_status("Törölve")
    ...
    def format_now(self):
        ...
        try:
            ...
            messagebox.showerror(APP_TITLE, f"Formázási hiba:\n{e}")
            return
